...
- [x] 3: Add an image
      Ein Foto einfügen.
      Dinge die in [] stehen, werden laut vorgelesen, für Menschen die einen Screenreader benutzen oder wenn das Bild nicht gezeigt werden kann.
      
- [x] 4: Add a code example
      Einen Code einfügen.
    
- [x] 5: Make a task list
